...
##sarima(climate.ts, 4,0,4,4,0,2,12) ## AIC: 3.79
##sarima(climate.ts,4,0,2,4,0,2,12) ## AIC: 3.75
##sarima(climate.ts,4,0,4,4,0,4,12) ## AIC: 3.84
##sarima(climate.ts,1,0,1,2,0,4,12) ## 3.83
##sarima(climate.ts,1,0,1,4,0,4,12) ## bad
##sarima(climate.ts,1,0,1,4,0,2,12) # 3.84
##sarima(climate.ts,1,0,1,1,0,3,12) ## 3.72
sarima(climate.ts,1,0,1,1,0,1,12) ## 3.71
##sarima(climate.ts,1,0,1,0,0,0,12) ## 4.82
##sarima(climate.ts,3,0,1,1,0,1,12) ## 3.719
##sarima(climate.ts,1,0,1,2,0,1,12) ## 3.72
```
\
\
